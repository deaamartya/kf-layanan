$(document).ready(function() {
    ...
    $('.tambah-bahan-baku-btn').click(function(){
        ...
        // Div pemisah
        var open_div = '<div id="div_bahan_baku_'+ no +'">';
        var close_div = '</div>'

    // Elemen bahan baku
    var input_bahan_baku = '<div class="form-group">' +
                                '<label class="col-form-label font-weight-bold">Bahan Baku</label>' +
                                '<span class="mx-1" style="text-decoration: underline">' +
                                    '<a href="#" class="text-danger remove_bahan_baku_btn">' +
                                        'remove' +
                                    '</a>' +
                                '</span>' +
    ...
    var input_supplier = '<div class="form-group">' +
                            '<label class="col-form-label font-weight-bold">Supplier Bahan Baku</label>' +
    ...
    var input_jumlah_kg = '<div class="form-group">' +
                                '<label class="col-form-label font-weight-bold">Jumlah Bahan Baku (Kg)</label>' +
    ...
    var input_jumlah_karung = '<div class="form-group">' +
                                '<label class="col-form-label font-weight-bold">Jumlah Bahan Baku (Karung)</label>' +
    ...
    var new_element = open_div + input_bahan_baku + input_supplier + input_jumlah_kg + input_jumlah_karung + close_div;
    ...
    //ambil bahan baku
        ...
        // remove bahan baku
        $('.remove_bahan_baku_btn').on('click', function(){
