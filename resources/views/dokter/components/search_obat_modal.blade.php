            ...
            <div class="modal-body py-3">
                ...
                <div class="mb-3">
                    <table class="table table-bordered">
                        <thead class="bg-linkedin">
                            <tr>
                                <th style="color: white !important; font-weight: bold;">Atorvastatin 20 mg</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                ...
                <div class="mb-3">
                    <table class="table table-bordered">
                        <thead class="bg-linkedin">
                            <tr>
                                <th style="color: white !important; font-weight: bold;">Amlodipin 10mg</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                ...
                <div class="">
                    <table class="table table-bordered">
                        <thead class="bg-linkedin">
                            <tr>
                                <th style="color: white !important; font-weight: bold;">Thiamphenicol 500mg</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
