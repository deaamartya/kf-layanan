            ...
            <div>
                <div class="list-group list-group-flush">
                    ...
                    <a href="" class="list-group-item">
                        <i class="ti-check list-group-icon mr-2"></i>
                        Send
                    </a>
                    <a href="" class="list-group-item">
                        <i class="ti-pencil-alt list-group-icon mr-2"></i>
                        Draft
                    </a>
                    <a href="" class="list-group-item d-flex align-items-center">
                        <i class="ti-star list-group-icon mr-2"></i>
                        Starred
                        <span class="small ml-auto">10</span>
                    </a>
                    <a href="" class="list-group-item">
                        <i class="ti-info-alt list-group-icon mr-2"></i>
                        Spam
                    </a>
                    <a href="" class="list-group-item d-flex align-items-center">
                        <i class="ti-trash list-group-icon mr-2"></i>
                        Trash
                        <span class="small ml-auto">2</span>
                    </a>
                </div>
            </div>
            <p class="mt-4 font-weight-bold">Labels</p>
            <div class="list-group list-group-flush">
                <a href="#" class="list-group-item d-flex align-items-center">
                    ...
                    <div class="card-header bg-white">
                        <div class="app-detail-action-left align-items-center">
                            ...
                            <h5 class="mb-0">
                                ...
                                <span class="badge bg-success-bright text-success badge-pill ml-1">Freelance</span>
                            </h5>
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <a href="#" data-toggle="tooltip" title="Keep" class="btn btn-outline-light mr-2">
                            <i class="ti-save"></i>
                        </a>
                        <a href="#" data-toggle="tooltip" title="Delete" class="btn btn-outline-light mr-2">
                            <i class="ti-trash"></i>
                        </a>
                    </div>
                    <form>
